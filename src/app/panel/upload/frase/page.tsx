...
const UploadFrase = () => {
    ...
    const handleUpload = async (e:any) => {
        ...
        try {
            const response = await api.post('/api/frase', formData, {
                headers: {
            ...
            <div className="color-background min-h-screen">
                ...
                <div className="color-background min-h-screen items-center justify-center h-screen flex flex-col">
                    <div className="color-navbar text-white p-8 rounded">
                        ...
                        <h1 className="text-center mb-8 text-2xl font-bold">Subir frase</h1>
                        <form>
                                ...
                                <div className="flex flex-col items-center gap-12">
                                    ...
                                    <div className="container">
                                        ...
                                        <label htmlFor="file" className="footer">
                                            ...
                                            <p className="text-white">{selectedFile? `"${selectedFile.name}" seleccionado` : "Seleccionar frase"}</p>
                                        </label>
